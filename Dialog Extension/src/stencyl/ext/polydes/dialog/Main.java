...
//		}
	...
	public boolean isInstalledForGame(Game game)
	{
		...
		return dgExtInstalled && dsExtInstalled &&
			(
				//v4 installation
				new File(Locations.getGameLocation(game) + "extras" + File.separator + dataFolderName).exists() ||
				//v5+ installation
	...
	private void downloadDialogEngineExtension(final Runnable callback)
	{
		...
		(
			"http://justin.espedaladventures.com/download/dialog.zip",
	...
	public void onGameWithDataOpened(Game game)
	{
		...
		dsExt.dataStructureExtensions.add(this);
		dsExt.dataTypeExtensions.add(this);
	}
